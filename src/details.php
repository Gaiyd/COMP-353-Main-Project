...
<div class="wrapper">
    ...
    <details>
        <summary>#11  Details of all company   (┛◉Д◉)┛彡┻━┻</summary>
    ...
    <details>
        <summary>#12  Details of all companies with a warehouse in every country with at least one contract.   (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧</summary>
        <form method="post">
    ...
    <details>
        <summary>#14  Details of all contract for Pfizer  (╯°Д°)╯︵/(.□ . \)</summary>
        <form method="post">
    ...
    <details>
        <summary>#15  Details of all contract signed by every client. (☞ﾟヮﾟ)☞ ┻━┻</summary>
        <form method="post">
    ...
    <details>
        <summary>#16  Details of all researcher who worked for at least three different companies.   (˚Õ˚)ر ~~~~╚╩╩╝ </summary>
        <form method="post">
    ...
    <details>
        <summary>#17  Details of all researcher who worked for all projects for Pfizer   ┬─┬ノ( º _ ºノ)</summary>
        <form method="post">
    ...
    <details>
        <summary>#19  Report of all the projects thats are performed by 
            Pfizer reasearch center that are located in the United States Of America     (๑و•̀ω•́)و
        </summary>
        <form method="post">
        ...
        <table class="displayTable">
            <tr>
                <th>Research facility name</th>
                <th>Research facility adress</th>
                <th>Research facility city</th>
                <th>Project name</th>
                <th>Team name</th>
                <th>Start date</th>
                <th>End date</th>
                <th>Total number of researcher</th> 
                <th>Total number of hour assigned</th>           
            </tr>
           <?php
